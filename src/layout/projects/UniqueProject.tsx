...
const UniqueProject = () => {
    ...
    if (uniqueProjects.length === 0) {
        return (
            <section className="py-16 md:py-20 bg-linear-to-b from-white to-gray-50 dark:from-[#0B0E1D] dark:to-[#0F172A]">
    ...
    return (
        <section className="py-16 md:py-24 bg-linear-to-b from-white to-gray-50 dark:from-[#0B0E1D] dark:to-[#0F172A]">
            <div className="container mx-auto px-4 sm:px-6">
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4 bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text">
                        Featured Projects
                    </h2>
